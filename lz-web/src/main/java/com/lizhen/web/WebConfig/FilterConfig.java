...
/*        if (request.getHeader("Origin") != null) {
        ...
        if( url.substring(url.lastIndexOf("\\")+1).equals("/login")||
            url.substring(url.lastIndexOf("\\")+1).equals("/app/task/regist")||
            url.substring(url.lastIndexOf("\\")+1).equals("/changePassword")||
            url.substring(url.lastIndexOf("\\")+1).equals("/losePassword")||
            url.substring(url.lastIndexOf("\\")+1).equals("/app/user/login")||
            url.substring(url.lastIndexOf("\\")+1).equals("/app/user/losePassword")||
            url.substring(url.lastIndexOf("\\")+1).equals("/app/user/sendMsg")){
